...
window{sf::VideoMode(1920, 1080), "MetroFinder"}, menu(window, stations), hovered_station{NULL}, selected_station{NULL, NULL}
{
...
void GraphDrawer::handleEvent()
{
    ...
    while (window.pollEvent(evt))
    {
        ...
        else if (temp == MenuDrawer::handleRes::DestinationSwap)
        {
